...
export class InitialSchema1723369575554 implements MigrationInterface {
  name = 'InitialSchema1723369575554';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
            ...
            ADD CONSTRAINT "FK_93e1f502d3e8c55b33471aca9d5" FOREIGN KEY ("groupId") REFERENCES "skill_group"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
    await queryRunner.query(`
            ALTER TABLE "group_competence"
